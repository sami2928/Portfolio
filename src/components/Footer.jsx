    ...
    <div className="max-w-[1300px] mx-auto flex justify-between p-6 md:p-20 text-sm md:text-lg mt-12">
      <div className="space-y-4">
        ...
        <div className="flex flex-row gap-6 text-gray-400 text-4xl">
          <a href="https://wa.me/923234200929" target="_blank">
            <FaWhatsapp />
          </a>
          <a
          ...
          <a
            href="https://x.com/SamiUlH31944468?t=LvyvXK9MKcgVytSsqqUaLg&s=08"
            target="_blank"
          >
            <FaTwitter />
          </a>
          <a
            href="https://www.instagram.com/samiulhaq307?utm_source=qr&igsh=MTZkdW5ia2diZGpsYw=="
            target="_blank"
          >
            <FaInstagram />
          </a>
